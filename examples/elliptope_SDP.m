...
% 
% function [Y, problem, S] = maxcut_simple(A)
% function [Y, problem, S] = maxcut_simple(A, p)
% function [Y, problem, S] = maxcut_simple(A, p, Y0)
%
...
% Change log:
    ...
    assert(nnz(A-A.') == 0, 'A must be real, symmetric.');
    ...
    % Pick the manifold of nxp matrices with unit norm rows.
