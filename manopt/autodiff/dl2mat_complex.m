...
% Each part of dlx is a struct containing dlarrays with fields real & imag 
    ...
    function x = dl2mat_cell(dlx)
        ...
        for ii = 1:length(dlx)
            ...
            elseif iscell(dlx{ii})
                ...
                % recover complex numbers
                x{ii} =    extractdata(dlx{ii}.real) + ...
                        1i*extractdata(dlx{ii}.imag);
            end
        end
    end
end
