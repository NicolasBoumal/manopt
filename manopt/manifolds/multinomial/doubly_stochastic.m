...
% This function takes element-wise non-negative matrix A and returns a
% doubly stochastic matrix B using Sinkhorn's algorithm. 

% The function input-output format is the following 
% B = doubly_stochastic(A, maxiter, mode)
% 
% B: n x n doubly stochastic matrix
% A: n x n element-wise non-negative matrix
% maxiter (optional): strictly positive integer representing the maximum 
%	number of iterations of the sinkhorn's algorithm. 
%	The default value of maxiter is n^2.
% mode (optional): Setting mode = 1 changes the behavior of the algorithm 
% 	such that the input A is an n x p matrix with AA' having and 
...
% Applications" inSIAM Journal on Matrix Analysis and Applications 30(1), 
% 261-275, 2008. 
