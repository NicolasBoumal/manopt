...
var Hyphenator = (function (window) {
	...
	prompterStrings = {
		'be': '???? ?????? ????? ?? ???? ???? ????????? ???????????. ???? ????? ???????? ????:',
		'cs': 'Jazyk této internetové stránky nebyl automaticky rozpoznán. Urcete prosím její jazyk:',
		...
		'kn': '??? ???? ????????? ?????????? ????????????????. ???????? ????? ????????? ??????:',
		'lt': 'Nepavyko automatiškai nustatyti šios svetaines kalbos. Prašome ivesti kalba:',
		'lv': 'Šis lapas valodu nevareja noteikt automatiski. Ludzu noradiet pamata valodu:',
		...
		'ru': '???? ????? ????? ?? ????? ???? ????????? ?????????????. ?????????? ??????? ????:',
		'sl': 'Jezika te spletne strani ni bilo mogoce samodejno dolociti. Prosim navedite jezik:',
		'sv': 'Spr%E5ket p%E5 den h%E4r webbplatsen kunde inte avg%F6ras automatiskt. V%E4nligen ange:',
		'tr': 'Bu web sitesinin dili otomatik olarak tespit edilememistir. Lütfen dökümanin dilini seçiniz%A0:',
		'uk': '???? ????? ???-????? ?? ???? ???? ????????? ???????????. ???? ?????, ??????? ??????? ????:'
	},
