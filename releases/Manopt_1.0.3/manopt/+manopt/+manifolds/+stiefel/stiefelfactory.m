...
%     end
    ...
    function rhess = ehess2rhess(X, egrad, ehess, H)
        ...
        XtG = manopt.tools.multiprod(manopt.tools.multitransp(X), egrad);
        symXtG = manopt.tools.multisym(XtG);
        HsymXtG = manopt.tools.multiprod(H, symXtG);
        rhess = PXehess - HsymXtG;
    end
