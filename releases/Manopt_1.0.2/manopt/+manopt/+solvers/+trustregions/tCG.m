...
% Change log: 
%  NB Feb. 12, 2013: We don't project r back to the tangent space anymore:
%                    it was not necessary, and as of Manopt 1.0.1, the proj
%                    operator does not coincide with this notion anymore.
%  NB April 3, 2013: tCG now also returns Heta, the Hessian at x along eta.
%                    Additional esthetic modifications.
