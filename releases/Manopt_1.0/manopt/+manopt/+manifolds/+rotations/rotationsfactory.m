...
% Change log: 
    ...
    function Y = retraction(X, U, t)
        ...
        for i = 1 : k
            ...
            % and compute their product for the determinant: its stricly
...
% Returns the skew parts of the matrices in the 3D matrix X
function Y = multiskew(X)
    Y = .5*(X - manopt.tools.multitransp(X));
end
