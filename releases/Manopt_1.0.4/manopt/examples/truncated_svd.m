...
%         approximation of A according to the Frobenius norm.
%         This function produces an output akin to svds. The code is easy
%         to modify to accept a function handle for A(x) = Ax instead of a
%         matrix A. Would need a function handle for the transpose of A to.
% 
...
% 
    ...
    % computationally efficient though, because much of the computations
