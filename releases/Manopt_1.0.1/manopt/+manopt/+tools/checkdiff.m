...
% Checks the consistency of the cost function and directional derviatives.
%
...
% Change log: 
    ...
    % as the square of the stepsize, ie, in loglog scale, the error should
    % have a slope of 2.
    mask = h >= 1e-4 & h <= 1e-2;
    P = polyfit(log10(h(mask)), log10(err(mask)), 1);
    fprintf('The slope should be 2. It is: %g.\n', P(1));
